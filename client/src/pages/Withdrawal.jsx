    ...
    <div className="flex h-screen bg-gray-100 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col">
        <header className="bg-white shadow-sm border-b border-gray-200 px-4 py-3">
          <h1 className="text-xl font-bold text-gray-900">Withdrawal Request</h1>
        </header>
                ...
                <div className="space-y-4 max-h-96 overflow-y-auto">
                  {withdrawals.length > 0 ? (
                    withdrawals.map((withdrawal) => (
                      <div key={withdrawal._id} className="p-4 bg-gray-50 rounded-lg border border-gray-100 hover:shadow-md transition-all duration-300">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <div className={`px-3 py-1 rounded-full text-xs font-bold shadow-sm ${
                            ...
                            withdrawal.status === 'processing' ? 'bg-yellow-500 text-white' :
                            withdrawal.status === 'pending' ? 'bg-blue-500 text-white' :
                        ...
                        <div className="text-xs text-gray-600 space-y-1 font-medium">
                          ...
                          {withdrawal.transactionHash && (
                            <div className="flex items-center">
                              <span className="mr-1">🔗</span>
                              <span className="font-mono text-[10px] bg-gray-100 px-1 py-[2px] rounded truncate">
                    ...
                    <div className="text-center py-8">
                      ...
                      <h3 className="text-lg font-bold text-gray-800 mb-1">📝 No Withdrawal History</h3>
                      <p className="text-gray-600 font-medium text-sm">Your withdrawal requests will appear here.</p>
                    </div>
                  )}
                </div>
              </div>
